...
public class VirtualAddCommand implements LightCommand {
    ...
    public boolean performAsConsole(ConsoleCommandSender consoleCommandSender, String[] args) {
        ...
        if(LightCore.instance.getSettings().syncType().equalsIgnoreCase("mysql") &&
            ...
            LightCoins.instance.getConsolePrinter().printInfo("Added " + amount + " " + virtualData.getCurrencyName() + " to " + virtualData.getPlayerName());
        ...
        LightCoins.instance.getConsolePrinter().printInfo("Added " + amount + " " + virtualData.getCurrencyName() + " from " + virtualData.getPlayerName());
