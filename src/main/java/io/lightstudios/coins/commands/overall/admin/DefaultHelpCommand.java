...
public class DefaultHelpCommand implements LightCommand {
    @Override
    ...
    public String getDescription() {
        return "Displays help for /lightcoins commands";
    }

    @Override
    public String getSyntax() {
        return "/lightcoins help";
    }
    ...
    public String getPermission() {
        return LightPermissions.DEFAULT_HELP_COMMAND.getPerm();
    }
    ...
    public boolean performAsPlayer(Player player, String[] args) {
        ...
        LightCore.instance.getMessageSender().sendPlayerMessage(
                player,
                LightCoins.instance.getMessageConfig().helpCommandDefault());
